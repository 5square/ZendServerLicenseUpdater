...
function SendResults
{
    ...
    $msg.To.Add("service.delivery@software2.com")
    $msg.To.Add("ryan.heath@software2.com")
...
# Finally, remove the resource folder
Remove-Item -Recurse -Force $downloadLoc
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDjXBvGQlHWoNcAoQ6Q7PPgJy
# rhGgghl7MIIFeDCCBGCgAwIBAgIQDEbbvOoSOoHBXAZAmpvZCDANBgkqhkiG9w0B
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUdBsQ9tjZMpFX
# oYvrYrPpZAwdmM8wSgYKKwYBBAGCNwIBDDE8MDqgGoAYAEEAcABwAHMAQQBuAHkA
# dwBoAGUAcgBloRyAGmh0dHBzOi8vd3d3LnNvZnR3YXJlMi5jb20gMA0GCSqGSIb3
# DQEBAQUABIIBAKCCFX3kfRh+rSVP6jK9+uUzTWoJM5+SYlfO7z3ghTZeoCz8lsWK
# di04bJ3RmKm4CIUPfOMx6HCKENPwant7MtX9ikXn3LzmqZDXUKLCtd7ICO2X9oBD
# lg1p2iO9ZlMfFk0Of6gRvgxZ9ORmkm0VKG5BOPQ+FlF8/FZPR8XNL+oSZwYxgtNP
# UnSJRrE7UYI2fTxeYzi91/RvAybW7Fl4xRnaJiXVqK/QttPwMk5ZnDM5W8cwNsX0
# mpx/N2Ipjbem36hni5CwTmIZ1LhNAm53dPDYlxz5bTJvLOeeP/ARoaOjJ1u5+okg
# w1XOPGRsqulqFhQz47wjWSycP7p0s3ezibuhggIPMIICCwYJKoZIhvcNAQkGMYIB
...
# CSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE3MTIwODE3
# Mjg1OVowIwYJKoZIhvcNAQkEMRYEFI87h8B6YsA3asgpOmMVmHuA0tmGMA0GCSqG
# SIb3DQEBAQUABIIBAI6dY6VMp+nDfZpnfp9xOoDrNr371hN0QhEKaI8nnYkeTUMO
# 0UEvHBWVo3dH2O6ED1h2P1OUMvh6NY9Fwy7TAadAgC9q1OQL5OVwe6xLgNi9La2q
# 2JCH1juGOxT2A+yRniSvfjr7jEf/cVFSqqB+w6GyeP2OPAB0JclUzyFDyUDXQ2Vg
# Emry3gOy7CFoWwOBMmybYDvxgIQBOKUZZyoaGycqZo48qaZZVxCw+M4xrzKTehS6
# ywwRE0s7Z+uCdp35NmTxG903kYDE9Nnzw27OVNVLQnz272rGwuSexbKIQ7q1VVoQ
# /P++oF2rckkxVgzyy+VJTqc/WKyiUO2rtsSm4r4=
